...
### Status
- Phases 0–4 complete (FLOW-001 through FLOW-036, plus FLOW-045 and FLOW-047 added by the Q4/Q8 decisions). FLOW-037 complete. Phase 5 continues with FLOW-038 (recruiter identity/roles/verification), FLOW-039 (backlog view), FLOW-040 (observability).
